...
contract Bank {
    ...
    function createAccount(
        string memory _name,  // Fixed incorrect parameter name
        ...
        // Create new account and store in the mapping
    ...
    function checkBalance(uint256 _accountNumber, uint256 _pin) public view returns (uint256) {
        ...
        require(accounts[_accountNumber].exists, "Account doesn't exist");
